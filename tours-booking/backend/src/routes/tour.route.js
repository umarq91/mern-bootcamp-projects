...
import { bookaTour, UploadItems, addTour, getTour, getTourDetails, getUserTours, tourDelete, tourUpdate, bookings } from "../controller/tourcrud.controller.js"
...
router.get('/adminbookings',verifyToken,bookings)
