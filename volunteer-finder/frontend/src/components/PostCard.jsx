...
function PostCard({ post }) {
  ...
  return (
    <Link to={`/event/${post.id}`} className='relative cursor-pointer hover:scale-105 transition-all duration-200 flex flex-col justify-between h-[420px] md:h-[380px] w-[80%] lg:w-[90%] p-4 border border-gray-300 rounded-lg shadow-md m-2'>
